...
void WeatherController::useDemoData()
{
    ++m_requestSerial;
    populateDemoData();
    m_loading = false;
    m_online = false;
    m_usingCache = false;
    m_dataSource = QStringLiteral("演示数据");
    m_errorMessage.clear();
    emit statusChanged();
    emit refreshFinished(true, QStringLiteral("已切换为本地演示天气"));
}
...
void WeatherController::populateDemoData()
{
