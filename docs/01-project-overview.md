...
DrivePilot Cockpit 最初基于 B 站公开的 Qt/QML 车载中控教学项目进行二次开发。教学项目提供了早期界面框架和部分基础页面，我在此基础上重新组织工程，并扩展了媒体、天气、联系人、模拟导航、DMS、语音识别和 Agent 等模块。原教学内容和原始素材的相关权利归对应作者。
...
- **Agent 服务**：ReAct 式多轮工具调用、WebSocket 会话、工具等待、超时和结果回传；
