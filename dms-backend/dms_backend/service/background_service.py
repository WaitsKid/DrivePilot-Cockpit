...
from dms_backend.fatigue.config import DmsServiceConfig
from dms_backend.fatigue.engine import FatigueEngine
from dms_backend.fatigue.types import VisualCueSample
from dms_backend.inference.config import load_inference_config
...
class DmsBackgroundService:
    ...
    def __init__(self, config: DmsServiceConfig, store: DmsStatusStore | None = None) -> None:
        self.config = config
    ...
    def initialize_models(self) -> bool:
        with self._lifecycle_lock:
            ...
            try:
                ...
                self._pipeline = DmsInferencePipeline(self.config.inference_config_path)
    ...
    def _run(self) -> None:
        try:
            ...
            inference = load_inference_config(self.config.inference_config_path)
            camera_config = inference.get("camera", {})
